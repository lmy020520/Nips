...
OUTPUT_JSON = "derived_counterfactual_analysis_v2.json"
OUTPUT_MD = "derived_counterfactual_analysis_v2.md"
...
def load_derived_strategy_analysis(base_dir: Path) -> dict:
    path = base_dir / "debug" / "derived_strategy_analysis_v2.json"
    with path.open("r", encoding="utf-8") as f:
        return json.load(f)
...
def main() -> None:
    ...
    payload = {
        "build_meta": {
            "run_id": run_id,
            "source": "analyze_derived_counterfactual_v2.py",
        },
