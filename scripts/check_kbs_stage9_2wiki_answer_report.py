#!/usr/bin/env python3
"""Validate a Stage 9.4 answer report against frozen 2Wiki selection."""
...
def main() -> None:
    ...
    result = {
        ...
        "stage": 9,
        "step": "9.4",
        "mode": "final_policy_2wiki_answer_smoke" if args.smoke else (
            "final_policy_2wiki_answer_report"
        ),
        "method": args.method,
        "qids": args.expected_qids,
        ...
        "next_gate": (
            ...
            if failures
                ...
                "Review the bounded smoke before authorizing the complete five-method answer chain."
                if args.smoke
