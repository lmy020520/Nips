...
DEFAULT_BASE = Path(__file__).resolve().parents[1] / "data" / "hotpotqa_distractor_v3"
...
def write_debug_manifest(base_dir: Path, *, debug_type: str, run_ids_by_split: Dict[str, str]) -> None:
    manifest_path = base_dir / "debug" / "build_manifest_v3.json"
    ...
    manifest["source"] = "build_hotpotqa_success_debug_v3.py" if debug_type == "success" else "build_hotpotqa_failure_debug_v3.py"
...
def build_debug_record(
    *,
    ...
    return {
        ...
        "build_meta": {
            "run_id": run_id,
            "source": "build_hotpotqa_success_debug_v3.py",
        },
