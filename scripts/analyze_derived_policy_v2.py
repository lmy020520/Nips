...
OUTPUT_JSON = "derived_policy_analysis_v2.json"
OUTPUT_MD = "derived_policy_analysis_v2.md"
...
def main() -> None:
    ...
    strategy_obj = read_json(base_dir / "debug" / "derived_strategy_analysis_v2.json")
    counterfactual_obj = read_json(base_dir / "debug" / "derived_counterfactual_analysis_v2.json")
    ...
    output = {
        "build_meta": {
            "run_id": run_id,
            "source": "analyze_derived_policy_v2.py",
        },
        **analysis,
    }
