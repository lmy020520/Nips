# KBS Experiment Records

This directory stores concise, paper-facing records of finalized experiments.
Raw reports remain under `outputs/`; these records preserve the frozen
protocol, principal numbers, uncertainty, conclusion, and claim boundary.
...
| 9.5 | Downstream state rollout | Closed: `STATE_RELEVANCE_DOWNSTREAM_SUPPORTED` | [Stage9.5_Downstream_State_Rollout_20260913.md](Stage9.5_Downstream_State_Rollout_20260913.md) |
| 9.6 | One breadth enhancement | Readiness audit pending | [Stage9.6_Breadth_Enhancement_20260914.md](Stage9.6_Breadth_Enhancement_20260914.md) |
